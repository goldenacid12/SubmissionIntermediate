...
import com.dicoding.latihan.submissionintermediate.database.RemoteKeys
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            ...
            val responseData = apiService.getStories(token, page, state.config.pageSize) as MutableList<ListStoryItem>
